...
@Component({
  selector: 'app-liste-foyer-etudiant',
  templateUrl: './liste-foyer-etudiant.component.html',
  styleUrls: ['./liste-foyer-etudiant.component.scss']
})
export class ListeFoyerEtudiantComponent  implements OnInit{
  searchTerm: string = '';
  foyers!: any;
  ...
  details(id: any) {
    this.router.navigate(['/dashboardEtudiant/foyer/detailFoyer', id]);
  }
}